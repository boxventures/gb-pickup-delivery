    ...
    <Container>
      ...
      <div>
        ...
        <form method="post" action={`${window.SHOPIFY_CART_URL}`} noValidate="novalidate">
          ...
          <CheckoutButton type="submit" name="checkout" disabled={checkoutDisabled} className="c-btn c-btn--primary c-btn--full" aria-label="Checkout">Checkout</CheckoutButton>
        </form>
      </div>
    </Container>
  )
